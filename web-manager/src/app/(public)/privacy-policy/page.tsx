...
export const metadata = {
  title: 'Privacy Policy — Kyber Vision Database Manager',
}
  ...
  return (
    <div className="relative flex min-h-dvh flex-col bg-background">
      ...
      <main className="mx-auto w-full max-w-3xl flex-1 px-6 py-10 md:px-10">
        ...
        <p className="mb-8 text-sm text-muted-foreground">Last updated: September 19, 2025</p>

        <div className="prose-sm space-y-6 text-sm leading-relaxed text-foreground/90 [&_h2]:mb-2 [&_h2]:mt-8 [&_h2]:text-lg [&_h2]:font-semibold [&_h2]:text-foreground [&_h3]:mb-1.5 [&_h3]:mt-5 [&_h3]:text-base [&_h3]:font-medium [&_h3]:text-foreground [&_ul]:space-y-1.5 [&_ul]:pl-5 [&_ul]:list-disc [&_ul>li]:text-foreground/80">
          ...
          <ul>
            ...
            <li><strong>Application</strong> refers to Kyber Vision 21, the software program provided by the Company.</li>
            <li><strong>Company</strong> (referred to as either &ldquo;the Company&rdquo;, &ldquo;We&rdquo;, &ldquo;Us&rdquo; or &ldquo;Our&rdquo; in this Agreement) refers to Kyber Vision 21.</li>
          ...
          <ul>
            <li>By email: <a href="mailto:nrodrig1@gmail.com" className="text-kyber-purple-light hover:underline">nrodrig1@gmail.com</a></li>
          </ul>
        </div>
      </main>
