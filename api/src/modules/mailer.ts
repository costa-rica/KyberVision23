...
export const sendRegistrationEmail = async (
  ...
  try {
    ...
    logger.error("Error sending email [sendRegistrationEmail]:", error);
    throw error;
  }
};
...
export const sendResetPasswordEmail = async (
  ...
  try {
    ...
    logger.info("[ sendResetPasswordEmail 3]emailTemplate:");
...
export const sendJoinSquadNotificationEmail = async (
  ...
  logger.info("-- sendJoinSquadNotificationEmail --");
  try {
    const templatePath = path.join(
      __dirname,
